        ...
        for alpha in range(0, wordsize):
            ...
            while weight < MAX_WEIGHT:
                ...
                if foundSolution(result):
                    print(
                        "Alpha: {} Beta: {} Gamma: {} Weight: {}".format(
...
def findMinWeightCharacteristic(cipher, parameters):
    ...
    while (
        ...
        if foundSolution(result):
            ...
            print(
                (
                    "Characteristic for {} - Rounds {} - Wordsize {} - "
                    "Weight {} - Time {}s".format(
                        cipher.name,
                        parameters["rounds"],
                        parameters["wordsize"],
...
def findAllCharacteristics(cipher, parameters):
    ...
    while (
        ...
        if foundSolution(result):
            ...
            print(
                "Found {} characteristics with weight {}".format(
...
def solveBoolector(stp_file):
    ...
    boolector_process = subprocess.Popen(
        boolector_parameters, stdout=subprocess.PIPE, stdin=subprocess.PIPE
    )
